...
export function CopyButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center font-medium transition-colors copy-button shrink-0 duration-base focus-visible-ring touch-manipulation ${tone} ${sizing} ${className}`}
    >
      ...
      <span
        className="copy-button-success hidden items-center gap-[inherit]"
        aria-hidden="true"
      >
